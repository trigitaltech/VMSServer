...
public class VendorDocumentManagementException extends AbstractPlatformDomainRuleException {
	
	private static final long serialVersionUID = 1L;

	public VendorDocumentManagementException(final String name) {
        super("error.msg.document.save", "Error while manipulating file " + name + " due to a File system / Amazon S3 issue", name);
    }

    public VendorDocumentManagementException(final String name, final Long fileSize, final int maxFileSize) {
