...
public class VendorDocumentCommandValidator {

    private final VendorDocumentCommand command;

    public VendorDocumentCommandValidator(final VendorDocumentCommand command) {
    ...
    public void validateForUpdate() {
        ...
        final DataValidatorBuilder baseDataValidator = new DataValidatorBuilder(dataValidationErrors).resource("vendordocument");
        ...
        baseDataValidator.reset().anyOfNotNull(this.command.getName(), this.command.getFileName(), 
